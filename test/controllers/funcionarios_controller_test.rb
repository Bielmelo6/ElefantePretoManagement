...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { cargo_id: @funcionario.cargo_id, cpf: @funcionario.cpf, email: @funcionario.email, nascimento: @funcionario.nascimento, nome: @funcionario.nome } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cargo_id: @funcionario.cargo_id, cpf: @funcionario.cpf, email: @funcionario.email, nascimento: @funcionario.nascimento, nome: @funcionario.nome } }
